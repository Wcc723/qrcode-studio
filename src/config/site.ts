...
export const site = {
  // 工具名。頁首、JSON-LD 的 WebSite／工具名稱都用這個；舊名 QRTool 已停用，不要再出現。
  name: 'QR Code Studio',
  // og:site_name：工具名＋站群名，分享卡片上看得出這是口袋工具的一部分。
  siteName: 'QR Code Studio｜口袋工具',
  ...
  ogImage: {
    ...
    width: 1200,
    height: 630,
    alt: 'QR Code Studio 免費 QR Code 產生器：線上製作、可加 LOGO',
  } satisfies OgImage,
