...
<template>
  <div class="py-8">
    <header class="max-w-screen-lg mx-auto px-4 mb-7 text-center">
      ...
      <p class="text-muted font-600 mt-4 max-w-xl mx-auto reveal reveal-3">線上免費製作 QR Code（QRCode）：瀏覽器內即時生成、不上傳，可自訂顏色與加入 LOGO，免費下載 PNG 與 SVG 向量檔，永久有效不過期。</p>
    </header>
